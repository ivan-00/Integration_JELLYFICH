...
console.log(randomNumber);
    // On demande au joueur de rentrer un entier dans une boite de dialogue.
    let nbrJoueur=0;
    let compt = 0;
    console.log(randomNumber);

// Tant qu'on a n' pas reussi , on demande au joueur de rentrer un entier dans une boite de dialogue.
while(nbrJoueur != randomNumber && compt < 3){
    ...
    // On indique au joueur via un popup su le nombre à trouver est plus petit ou plus grand.
